// import { EventBus } from '../../infrastructure/rabbitmq/eventbus'
// import { IEventHandler } from '../../infrastructure/port/event.handler.interface'
// import { IClientRequest } from '../../infrastructure/port/resource.handler.interface'
//
...
//                     .registerClientDirectOrTopic(this.typeConnection, exchangeName, clientRequest, timeout, callback)
//                     .then(result => {
//                     return resolve(result)
//                 })
//                     .catch(err => {
