...
const bus_message_1 = require("../bus/bus.message");
let MessageSenderRabbitmq = class MessageSenderRabbitmq {
    ...
    sendRoutingKeyMessage(exchangeName, routingKey, message, options) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const msg = new bus_message_1.BusMessage(message.content, message.properties);
