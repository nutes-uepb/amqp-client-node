export declare abstract class Identifier {
    ...
    static readonly RABBITMQ_CLIENT_REGISTER: any;
    static readonly RABBITMQ_SERVER_REGISTER: any;
    static readonly TOPIC_DIRECT: any;
    static readonly TOPIC: any;
    static readonly DIRECT: any;
    static readonly CUSTOM_EVENT_EMITTER: any;
}
